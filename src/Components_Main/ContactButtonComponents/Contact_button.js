    ...
    <div className="contact">
      <Popup
        ...
        position="right center">
          ...
          <input type="text" id="mail" name="mail"placeholder="name@example.com" ></input>
          <label for="Message">Message</label>
          <textarea id="Message" name="Message" placeholder="Write something.." cols="20" rows="5" ></textarea>
